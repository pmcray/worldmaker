...
DATA = {
    ...
    'star_mao': { # Page 39, Minimum Allowable Orbit# (MAO) by type and class
        'Ia': {'O0': 0.63, 'O5': 0.55, 'B0': 0.50, 'B5': 1.67, 'A0': 3.34, 'A5': 4.17, 'F0': 4.42, 'F5': 5.00, 'G0': 5.21, 'G5': 5.34, 'K0': 5.59, 'K5': 6.17, 'M0': 6.80, 'M5': 7.20, 'M9': 7.80},
        'Ib': {'O0': 0.60, 'O5': 0.50, 'B0': 0.35, 'B5': 0.63, 'A0': 1.40, 'A5': 2.17, 'F0': 2.50, 'F5': 3.25, 'G0': 3.59, 'G5': 3.84, 'K0': 4.17, 'K5': 4.84, 'M0': 5.42, 'M5': 6.17, 'M9': 6.59},
        'II': {'O0': 0.55, 'O5': 0.45, 'B0': 0.30, 'B5': 0.35, 'A0': 0.75, 'A5': 1.17, 'F0': 1.33, 'F5': 1.87, 'G0': 2.24, 'G5': 2.67, 'K0': 3.17, 'K5': 4.00, 'M0': 4.59, 'M5': 5.30, 'M9': 5.92},
        'III': {'O0': 0.53, 'O5': 0.38, 'B0': 0.25, 'B5': 0.15, 'A0': 0.13, 'A5': 0.13, 'F0': 0.13, 'F5': 0.13, 'G0': 0.25, 'G5': 0.38, 'K0': 0.50, 'K5': 1.00, 'M0': 1.68, 'M5': 3.00, 'M9': 4.34},
        'IV': {'B0': 0.20, 'B5': 0.13, 'A0': 0.10, 'A5': 0.07, 'F0': 0.07, 'F5': 0.06, 'G0': 0.07, 'G5': 0.10, 'K0': 0.15},
        'V': {'O0': 0.50, 'O5': 0.30, 'B0': 0.18, 'B5': 0.09, 'A0': 0.06, 'A5': 0.05, 'F0': 0.04, 'F5': 0.03, 'G0': 0.03, 'G5': 0.02, 'K0': 0.02, 'K5': 0.02, 'M0': 0.02, 'M5': 0.01, 'M9': 0.01},
        'VI': {'O0': 0.01, 'O5': 0.01, 'B0': 0.01, 'B5': 0.01, 'G0': 0.02, 'G5': 0.02, 'K0': 0.02, 'K5': 0.01, 'M0': 0.01, 'M5': 0.01, 'M9': 0.01}
    },
    'stellar_orbit_ranges': { # Page 27, non-primary star Orbit# determination
        'Close': lambda: max(0.5, random.randint(1, 6) - 1),
        'Near': lambda: random.randint(1, 6) + 5,
        'Far': lambda: random.randint(1, 6) + 11,
        'Companion': lambda: random.randint(1, 6) / 10 + (sum(random.randint(1, 6) for _ in range(2)) - 7) / 100
    },
